...
class RecordingsAdapter extends RecyclerView.Adapter<RecordingsAdapter.HomeFoodViewHolder> {
    ...
    public RecordingsAdapter(Context context, FoodClickListener foodClickListener) {
